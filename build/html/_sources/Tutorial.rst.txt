...
#.  `Intro <#intro>`__
#.  `Overview <#overview>`__ (as close to a tl;dr that's still
    meaningful)

  #.  `Infra Model <#ov_inframodel>`__
  #.  `Namespace Model <#ov_namespacemodel>`__
  #.  `Configuration Model <#ov_configmodel>`__
  #.  `Execution Model <#ov_execmodel>`__

3.  `Configuring for OpenStack <#os_config>`__
#.  `Infra models <#inframodels>`__

  #. `A simple Openstack example <#simple_openstack_example>`__
  #. `Multiple Resources <#multi_resources>`__
  #. `Resource Groups <#resource_groups>`__
  #. `Model References, Context Expressions, and the Nexus <#modrefs_ctxtexprs>`__

5. `Namespace models <#nsmodels>`__

  #. `An example <#simplensexample>`__
  #. `Dynamic Namespaces <#dynamicns>`__
  #. `Var objects <#varobjs>`__
  #. `Variable setting and overrides <#overrides>`__
  #. `Variable references <#varrefs>`__

6. `Configuration models <#configmodels>`__

  #. `Declaring tasks <#taskdec>`__
  #. `Declaring dependencies <#taskdeps>`__
  #. `Dependency expressions <#depexp>`__
  #. `Auto-scaling tasks <#taskscaling>`__
  #. `Config classes as tasks <#classtasks>`__
  #. `Reference selection expressions <#refselect>`__

7. Execution Models (yet to come)
#. `Orchestration <#orchestration>`__-- putting it all together

  #. Initiating a system
  #. Tearing a system down
  #. Inspecting errors
  #. Persisting models of initiated systems
